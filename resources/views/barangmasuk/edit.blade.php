                    ...
                    <div class="card-body">
                        <form action="{{ route('barangmasuk.update',$rsetBarang->id) }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('qty_masuk') is-invalid @enderror" name="qty_masuk" value="{{ old('qty_masuk',$rsetBarang->qty_masuk) }}" placeholder="Masukkan QTY Masuk">
