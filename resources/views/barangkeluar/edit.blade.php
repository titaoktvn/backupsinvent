                    ...
                    <div class="card-body">
                        <form action="{{ route('barangkeluar.update',$rsetBarang->id) }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('qty_keluar') is-invalid @enderror" name="qty_keluar" value="{{ old('qty_keluar',$rsetBarang->qty_keluar) }}" placeholder="Masukkan QTY Keluar">
